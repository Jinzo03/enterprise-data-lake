...
print(" Extracting raw JSON logs from S3 via Athena...")
...
print(f" Transforming and PARTITIONING {len(df)} rows into Columnar Parquet...")

# 2. Write partitioned Parquet dataset back to S3
# 'mode="overwrite"' resets the analytics directory cleanly for this lab environment
wr.s3.to_parquet(
    df=df,
...
print(" Partitioned ETL Job Complete! Table 'optimized_analytics' is fully optimized.")